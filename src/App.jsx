...
// Винести повторювані класи в константи
...
// Функція для визначення класів з урахуванням активного стану
  ...
  return (
    <>
      <nav className="flex flex-row items-center justify-center gap-2 border-b-4 border-black bg-gray-900 p-2 text-lg">
        ...
        <NavLink to="/coctails" className={getNavLinkClass}>
          Coctails
        </NavLink>
      ...
      >
        <Routes>
          ...
          <Route path="/coctails" element={<CoctailsMain />} />
